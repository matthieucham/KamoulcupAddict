 ...
 * presented as a single list. On tablets, settings are split by category, with category headers shown to the left
 * of the list of settings.
 * <p>
...
{
  /**
   * Determines whether to always show the simplified settings UI, where settings are presented in a single list.
   * When false, settings are shown as a master/detail two-pane view on tablets. When true, a single pane is shown
   * on tablets.
   */
  ...
  private void setupSimplePreferencesScreen()
  {
    ...
    bindPreferenceSummaryToValue(findPreference("pref_resolutionSpeed"));
  }
